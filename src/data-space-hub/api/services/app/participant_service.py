...
from api.models.dto.responses import ErrorResponse, ParticipantResponse, SimpleMessageResponse
...
class ParticipantService:
    ...
    async def start_participant_registration(self, request: ParticipantCreateRequest) -> SimpleMessageResponse:
        ...
        try:
            ...
            return ErrorResponse(str(e), detail="Something occured")

    async def update_participant_registration_status(
        self, rr_id: str, _status: RegistrationStatus
    ...
    async def get_participant(
        self, token: str, participant_id: str = None, participant_did: str = None
    ) -> ParticipantResponse:
        try:
            keycloak_service._decode_jwt_payload(token)
            if not (
