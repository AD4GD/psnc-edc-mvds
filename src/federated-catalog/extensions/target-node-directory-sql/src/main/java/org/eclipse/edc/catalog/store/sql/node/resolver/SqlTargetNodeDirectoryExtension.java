...
package org.eclipse.edc.catalog.store.sql.node.resolver;

import org.eclipse.edc.catalog.store.sql.node.resolver.schema.postgres.PostgresDialectStatements;
...
public class SqlTargetNodeDirectoryExtension implements ServiceExtension {
    ...
    @Setting
    private final String DATA_SOURCE_NAME_SETTING = "edc.sql.store.targetnodedirectory.datasource";
