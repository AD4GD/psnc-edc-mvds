...
## ****************************************************************************
#
# pytest-http documentation build configuration file, created by
...
project = u'pytest-http'
copyright = u'2015, Piotr Śniegowski'
...
man_pages = [
    (master_doc, 'pytest-cookiecutterplugin_name', u'pytest-http Documentation',
     [author], 1)
]
